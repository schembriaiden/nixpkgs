...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    repo = "ladybird";
    rev = "7008fd1ab3eb8dc9e672c623744391808df5ab48";
    hash = "sha256-TiRnFElvTHiO3TwFZmAHjb8tA3oH8PUYkQ+GvpB9HDc=";
  };
  ...
  patches = lib.optionals stdenv.hostPlatform.isLinux [
    # https://github.com/LadybirdBrowser/ladybird/issues/11727
    ./allow-vectored-io.patch
